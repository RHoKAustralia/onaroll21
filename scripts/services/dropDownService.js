					...
					if (dropdown_type == "reportCommentConfirmation"){
						...
						$(".popdown").click( function() {
						    ...
						    // send http request to the server
					         ...
					         $http.post(absolutePath+'/api/comment/report', {postid : commentReportIDs['post_id'], commentid : commentReportIDs['comment_id'], userid : commentReportIDs['user_id'], groupid : commentReportIDs['group_id']}).then(function(result){
					                console.log(result);
					...
					if (dropdown_type == "reportPostConfirmation"){
						...
						$(".popdown").click( function() {
						    ...
						    // send http request to the server
					         ...
					         $http.post(absolutePath+'/api/post/report', {postid : postReportIDs['post_id'], userid : postReportIDs['user_id'], groupid : postReportIDs['group_id']}).then(function(result){
