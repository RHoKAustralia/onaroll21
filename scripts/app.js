...
var conversationID = "";
var currentRoute = "";
var absolutePath = "http://new.onaroll21.com";
...
app.directive('sideMenu', function () {
    return {
        ...
        link: function() {
            $(".side-menu-layer, #side-menu a, #side-menu .close-link").click(function() {
...
app.directive('groupUsers', function () {
    return {
        ...
        controller: function($scope, $filter, SessionService, $http) {
            $(".side-menu-layer, #group-users-menu .close-link").click(function() {
            ...
            $scope.openSingleMessage = function(recipient) {
                ...
                $http.post(absolutePath+'/api/service/groupmessage/addUserToConversation', { userlist : JSON.stringify(messageUsers), conversationID: conversationID, type: 'single'}).
...
app.directive('selectUsers', function() {
    return {
        ...
        controller: function($scope, $filter, SessionService, $http) {
            $scope.checkSelectedUsers = function() {
                //console.log("ALL USERS");
                //console.log($scope.users);
                //console.log("SELECTED USERS");
                //console.log(SessionService.get("selectedUsers"));
                var selectedUsers = JSON.parse(SessionService.get("selectedUsers"));

                angular.forEach($scope.users, function(userVal,userKey) {
            ...
            $scope.openMessage = function(users) {
                ...
                if (checked.length) {
                    ...
                    $http.post(absolutePath+'/api/service/groupmessage/addUserToConversation', { userlist : JSON.stringify(selectedUsers), conversationID: conversationID, type: type}).
                    success(function(data, status, headers, config) {
