...
app.controller('PreSurveyCtrl',function($scope,$location,SessionService, $http, $rootScope, dropdownService, $timeout){
    ...
    $http.post(absolutePath+'/api/survey/getSurveyList', {'type': 'pre', 'groupid':$scope.selectedGroupId}).
					    success(function(data, status, headers, config) {
                          ...
                          if (optionNum == 0){
                            ...
                            $http.post(absolutePath+'/api/user/survey/completePreSurvey', { groupid: $scope.selectedGroupId, surveyid: 10 }).
                            success(function(data, status, headers, config) {
