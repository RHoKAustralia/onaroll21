...
app.controller('GroupMessageCtrl',function($scope,$location,SessionService,APICallService,$log, $rootScope, $http, $timeout){
    ...
    $scope.init = function (){
            ...
            if (!SessionService.get("conversationid")){
              ...
              $http.post(absolutePath+'/api/groupMessage/initRoomData', {gid : $scope.groupid}).
    ...
    $scope.memberList = function (){
	    	...
	    	$http.post(absolutePath+'/api/groupMessage/memberList', {gid : $scope.groupid}).
		    success(function(data, status, headers, config) {
    ...
    $scope.addMemberToList = function(uid, name){
        ...
        console.log(active_member_stack);
            ...
            $http.post(absolutePath+'/api/groupMessage/newMember', {roomid :  SessionService.get("conversationid"), newmemberid : memberObj.uid, newmemberfname : memberObj.name , userList : active_member_stack}).
            success(function(data, status, headers, config) {
    ...
    $scope.removeMember = function(uid, name){
                ...
                $http.post(absolutePath+'/api/groupMessage/removeMember', {roomid :  SessionService.get("conversationid"), newmemberid : uid, newmemberfname : name , userList : active_member_stack}).
                success(function(data, status, headers, config) {
    ...
    $scope.sendMessage = function(){
        ...
        if (tempMessage){
            $http.post(absolutePath+'/api/groupMessage/send', {id : SessionService.get("conversationid"), message : tempMessage, userList : active_member_stack}).
            success(function(data, status, headers, config) {
    ...
    $scope.messageList = function(){
        ...
        $http.post(absolutePath+'/api/groupMessage/messageList', {id : SessionService.get("conversationid")}).
                      success(function(data, status, headers, config) {
    ...
    $scope.getTheCurrentUserLIst = function(){
        ...
        $http.post(absolutePath+'/api/groupMessage/getTheCurrentUserLIst', {id : SessionService.get("conversationid")}).
                      success(function(data, status, headers, config) {
    ...
    $scope.leaveChat = function (){
        ...
        $http.post(absolutePath+'/api/groupMessage/leaveChat', {id : SessionService.get("conversationid")}).
                      success(function(data, status, headers, config) {
