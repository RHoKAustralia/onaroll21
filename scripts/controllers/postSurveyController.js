...
app.controller('PostSurveyCtrl',function($scope,$location,SessionService, $http, $rootScope, dropdownService, $timeout){
    ...
    $http.post(absolutePath+'/api/survey/getSurveyList', {'type': 'post', 'groupid':$scope.selectedGroupId}).
					    success(function(data, status, headers, config) {
                          ...
                          if (optionNumEx == 0){
                            ...
                            $http.post(absolutePath+'/api/user/survey/completePostSurvey', { groupid: $scope.selectedGroupId, surveyid: 10 }).
                            success(function(data, status, headers, config) {
