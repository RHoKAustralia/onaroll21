...
app.controller('PostsCtrl', function ($scope,
    ...
    $http.post(absolutePath+'/api/mission/detectLastMission', {'taskid': $scope.pendingTask,'groupid': $scope.groupid}).
...
app.controller('PostEditCtrl', function ($scope,
    ...
    $http.post(absolutePath+'/api/post/fetchPostByID', {'postid': SessionService.get('postedit.id')}).
          success(function(data, status, headers, config) {
        ...
        if (!$scope.post.status){
          ...
          // remove ajax loader out of body
           $rootScope.removeAjaxLoader();
            ...
            /*
            $http.post(absolutePath+'/api/post/submitEditedContent', $scope.post).
            success(function(data, status, headers, config) {
