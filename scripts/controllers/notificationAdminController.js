...
app.controller('NotificationAdminCtrl', function ($scope,
				...
				// BEGIN THE MAIN FUNCTION
    				...
    				$http.post(absolutePath+'/api/notification/getNotification').
					...
					$scope.notificationcbFunction = function(){
						...
						$http.post(absolutePath+'/api/notification/setNotification', {'type': 'normal', 'data': notificationcbStatus}).
					    success(function(data, status, headers, config) {
					      // this callback will be called asynchronously
					      // when the response is available
					...
					$scope.emailnotificationcbFnction = function(){
						...
						$http.post(absolutePath+'/api/notification/setNotification', {'type': 'email', 'data': notificationcbStatus}).
					    success(function(data, status, headers, config) {
					      // this callback will be called asynchronously
					      // when the response is available
					...
					$scope.pushnotificationcbFnction = function(){
						...
						$http.post(absolutePath+'/api/notification/setNotification', {'type': 'push', 'data': notificationcbStatus}).
					    success(function(data, status, headers, config) {
					      // this callback will be called asynchronously
					      // when the response is available
					    ...
					    /*$timeout(function() {
					    	...
					    	$http.post(absolutePath+'/api/service/updateDeviceStatus', {'status': notificationcbStatus, 'playerID': SessionService.get('playerid')}).
						    success(function(data, status, headers, config) {
						      // this callback will be called asynchronously
						      // when the response is available
					...
					$scope.webnotificationcbFunction = function(){
						...
						$http.post(absolutePath+'/api/notification/setNotification', {'type': 'web', 'data': notificationcbStatus}).
					    success(function(data, status, headers, config) {
					      // this callback will be called asynchronously
					      // when the response is available
